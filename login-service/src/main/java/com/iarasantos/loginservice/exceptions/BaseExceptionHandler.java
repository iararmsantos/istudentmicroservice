package com.iarasantos.loginservice.exceptions;

import com.iarasantos.loginservice.model.ErrorMessage;
...
public class BaseExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> handleArgumentNotValidException(MethodArgumentNotValidException exception) {
